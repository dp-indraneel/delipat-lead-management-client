            ...
            {lead ? (
              <>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                  ...
                  <ReadOnlyField label="Updated At" value={lead.updatedAt} />
                </div>
                ...
                <CustomFieldsEditor
                  ...
                  onChange={updateCustomFieldRows}
                />
                <JsonCodeViewer
                  label="Payload"
                  fileName="lead-payload.json"
                  value={lead.payload || {}}
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setError(getApiFormMessage(nextError, "Failed to update lead"));
                  } finally {
                    setSaving(false);
                  }
                }}
...
function CustomFieldsEditor({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="space-y-3 rounded-2xl border border-[#013144]/12 bg-[#013144]/[0.03] p-3">
        {rows.map((row) => (
          <div key={row.id} className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
            <LeadInputField
              label="Key"
              hideLabel
              value={row.key}
